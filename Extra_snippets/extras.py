...
app.layout = html.Div(children=[
    ...
    html.Div(children=[
        ...
        html.Div(style={'width':'60%', 'display': 'inline-block'},children=[
                ...
                html.Div(style={'display': 'inline','word-wrap': 'break-word'},children=iss_func(issues))
...
@app.callback(Output('0_message', 'children'),
              [Input('0_button', 'submit_n_clicks')])
